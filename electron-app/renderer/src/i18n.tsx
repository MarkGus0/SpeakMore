...
export const translations = {
  'zh-CN': {
    ...
    'settings.macosAccessibility.readyHint': 'Option 快捷键和后续自动粘贴诊断可以使用辅助功能能力。',
    'settings.macosAccessibility.missingHint': '请允许当前终端或 SpeakMore 使用辅助功能，否则全局 Option 快捷键和后续粘贴能力不可用。',
  ...
  'en-US': {
    ...
    'settings.macosAccessibility.readyHint': 'Option shortcuts and later paste diagnostics can use Accessibility APIs.',
    'settings.macosAccessibility.missingHint': 'Allow the current terminal or SpeakMore in Accessibility, otherwise global Option shortcuts and later paste support are unavailable.',
